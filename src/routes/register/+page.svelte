<script lang="ts">
  ...
  let filterOS: string = $state(userOS);
  ...
  <div class="timeline">
    <div class="timeline-item">
      ...
      <p class="timeline-text">
        Your Jabbra ID is your unique identifier on the platform. It should be
        memorable and easy to share with others.
      </p>
    ...
    <div class="timeline-item">
      ...
      <p class="timeline-text">
        After registering, you can choose a Jabber client that suits your needs.
        Since XMPP is an open protocol, there are many clients available for
        different platforms. Here is our recommendation:
      </p>
      <div class="flex flex-row gap-2">
        <p>Your detected platform: {userOS}</p>
        <img
          src={`/icons/${userOS.toLowerCase()}.svg`}
          alt={userOS}
          class="w-6 h-6 ml-2"
        />
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
        {#each filteredApplications as app}
          <div class="timeline-app bg-white dark:bg-mist-800">
            ...
            <p class="timeline-text text-gray-500 mt-1">{app.description}</p>
            <a
              href={app.url}
              target="_blank"
    ...
    <div class="timeline-item">
      ...
      <p class="timeline-text">
        Once you've downloaded and set up your client, you can start chatting
        with your friends and family. Enjoy your new Jabbra ID!
      </p>
      <p class="timeline-text">
        You will also receive a little welcome message from us to get you
        started. If you have any questions or need help, feel free to reach out
        to me.
      </p>
    </div>
  </div>
